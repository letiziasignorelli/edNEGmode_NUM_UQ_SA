...
### FIGURE9 ###
data = un.Data()
data.load(filename='data/simulation_outputs/UQSA_dyn_state/phi_msn_5/nr_spikes.h5')
sobol_1_nap = data['nr_spikes']['sobol_first']
sobol_tot_nap = data['nr_spikes']['sobol_total']
sobol_1_tlap = data['last_spike']['sobol_first']
sobol_tot_tlap = data['last_spike']['sobol_total']
...
axesB.set_title(r"$T_\mathrm{lAP}$", size=20, pad=17)
...
plt.savefig('plot_figures/figures/figure9.eps', format='eps')
plt.show()
