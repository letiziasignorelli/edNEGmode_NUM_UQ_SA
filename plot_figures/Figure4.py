...
#############    FIGURE3    #############
# Plot convergence analysis for e_{inf} #
#########################################
...
print("--------------------------------------------------")
print('Errors norm: ' + str(normvalue) + ', Pathological ')
print("--------------------------------------------------")
...
axesA.set_ylabel(r'$e_{\infty}^{\mathrm{[K^+]_{se}}}$', size=13)
axesC.set_ylabel(r'$e_{\infty}^{\mathrm{V_{se}}}$', size=13)
...
plt.savefig('plot_figures/figures/figure4.eps', format='eps')
plt.show()
