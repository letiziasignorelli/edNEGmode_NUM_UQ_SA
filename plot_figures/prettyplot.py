...
"""
Code adjusted from Uncertainpy: a Python toolbox for uncertainty quantification and sensitivity analysis, tailored towards computational neuroscience.
https://github.com/simetenn/uncertainpy.git 
"""
...
concentrations = ['Na_sn', 'Na_se', 'Na_sg', 'Na_dn', 'Na_de', 'Na_dg', 'K_sn', 'K_se', 'K_sg', 'K_dn', 'K_de', 'K_dg', 'Cl_sn', 'Cl_se', \
                'Cl_sg', 'Cl_dn', 'Cl_de', 'Cl_dg', 'Ca_sn', 'Ca_se', 'Ca_dn', 'Ca_de']

volumes = ['V_sn', 'V_se', 'V_sg', 'V_dn', 'V_de', 'V_dg']

def switch(type, var):    
    if type == "sol":
        sol_list = ['Na_sn', 'Na_se', 'Na_sg', 'Na_dn', 'Na_de', 'Na_dg', 'K_sn', 'K_se', 'K_sg', 'K_dn', 'K_de', 'K_dg', 'Cl_sn', 'Cl_se', \
                'Cl_sg', 'Cl_dn', 'Cl_de', 'Cl_dg', 'Ca_sn', 'Ca_se', 'Ca_dn', 'Ca_de', 'n', 'h', 's', 'c', 'q', 'z', 'V_sn', 'V_se', 'V_sg', 'V_dn', 'V_de', 'V_dg']
        return sol_list.index(var)
    
    elif type == "phi":
        sol_list = ['phi_sn', 'phi_se', 'phi_sg', 'phi_dn', 'phi_de', 'phi_dg', 'phi_msn', 'phi_mdn', 'phi_msg', 'phi_mdg']
        return sol_list.index(var)
    
    elif type == "E":
        sol_list = ['E_Na_sn', 'E_Na_sg', 'E_Na_dn', 'E_Na_dg', 'E_K_sn', 'E_K_sg', 'E_K_dn', 'E_K_dg', 'E_Cl_sn', 'E_Cl_sg', 'E_Cl_dn', 'E_Cl_dg', 'E_Ca_sn', 'E_Ca_dn']
        return sol_list.index(var)
...
Set tick style options
    ...
    params = {"xtick.color": ticks_color,
              "ytick.color": ticks_color,
...
def set_legend(labels, ax=None, **kwargs):
    ...
    legend = plt.legend(labels, **kwargs)
