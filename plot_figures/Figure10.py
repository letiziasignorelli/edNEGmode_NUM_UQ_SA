...
### FIGURE10 ###
data = un.Data()
data.load(filename='data/simulation_outputs/UQSA_dyn_state/K_se_5/K_se.h5')
...
# Set legend
set_legend(labels=params, bbox_to_anchor=(0.75,1.27), fontsize=13, ncol=6, frameon=False, columnspacing=1.5)
...
plt.savefig('plot_figures/figures/figure10.eps', format='eps')
plt.show()
